...
winget install -e -h --id Microsoft.VisualStudio.2022.Professional --silent --override "--wait --quiet --addProductLang En-us --config $env:USERPROFILE\Source\Repos\Automate%20Stuff\config\vs2022\.vsconfig"
